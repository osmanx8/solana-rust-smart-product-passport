        ...
        <Card className="border-none shadow-none">
          <CardHeader className="px-8 pt-8">
            <CardTitle className="flex flex-col items-center space-y-4">
              ...
              <img src="https://svgl.app/library/discord.svg" alt="Discord" className="w-10 h-10" />
          ...
          <CardContent className="mx-auto px-8">
            <p className="text-lg text-muted-foreground leading-relaxed mb-8 text-center">
              Join our Smart Product Passport Discord community! Connect, share, and grow with
